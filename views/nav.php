         ...
         <div class="navbar-nav ms-auto">
             ...
             <div class="dropdown">
                 ...
                 <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                     ...
                     <li>
                         <a class="dropdown-item" href="crear_categoria.php">
                             <i class="bi bi-folder-plus me-2"></i> Nueva Categoría
                         </a>
                     </li>
                     <li>
                         <a class="dropdown-item" href="baja.php">
                             <i class="bi bi-archive me-2"></i> Ver productos en baja
                         </a>
                     </li>

                     <li>
                         <a class="dropdown-item" href="#">
                             <i class="bi bi-cloud-upload me-2"></i> Subir Alegra
                         </a>
                     </li>
